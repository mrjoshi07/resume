                  ...
                  <div class="panel panel-primary">
                       ...
                       <div class="panel-body">
                          ...
                          <?php
                                   require("dbcon1.php");
                                   $id=$_SESSION["id"];
                                   $sql="select max(srno) from hardskills where id='$id'";
                            ...
                            <div class="form-group">
                                   <textarea name="txthardskill" id="txthardskill" class="form-control" rows="3" required="required" placeholder="Enter Your Hardskills"></textarea>
                            </div>
                            
                            <button type="submit" class="btn btn-primary" name="savehardskill">Submit</button>
                          </form>     
                       </div>
                  </div>
</div>  
...
<div class="col-xs-7 col-sm-7 col-md-7 col-lg-7 col6">
                  ...
                  <div class="panel panel-primary">
                       <div class="panel-heading">
                            <h3 class="panel-title">My Hardskill</h3>
                       </div>
                       <div class="panel-body">
                            ...
                            <?php
                                   ...
                                   if(mysqli_num_rows($res)>0)
                                   {
                                          while($row=mysqli_fetch_array($res))
                                          {
                                                 ...
                                                 echo "<td>".$row["2"]."</td>";
                                                 ?> <td><a href='hardskillsave.php?btndelete=delete&srno=<?php echo $row["srno"] ?>' type='button' class='btn btn-danger'>
